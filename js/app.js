...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_f1d6b3b5bd7e6061c0621a7e93d3c0f9a334f60a": function($0, $1) {
                Module.STDWEB.from_js($0, (function(){Module.exports.validate_metadata = Module.STDWEB.to_js($1);})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.aligned_media_validator.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "aligned_media_validator.wasm" );
        ...
        const __promise = fetch( "aligned_media_validator.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'aligned_media_validator'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'aligned_media_validator':", error );
                throw error;
            });

        Rust.aligned_media_validator = __promise;
        return __promise;
    }
}));
